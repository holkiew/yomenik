...
export default class ConfirmModal extends React.Component<ConfirmModalProps> {
    public render() {
        return (<Modal isOpen={this.props.openModal} fade={false} toggle={this.props.toggle}>
                    ...
                    <ModalFooter>
                        <Button color="primary" onClick={this.onConfirm}>{this.props.confirmBtnText !== undefined ? this.props.confirmBtnText : "Yes"}</Button>{' '}
                        <Button color="secondary" onClick={this.props.toggle}>{this.props.cancelBtnText !== undefined ? this.props.cancelBtnText : "Cancel"}</Button>
                    </ModalFooter>
                </Modal>);
    }
